"""task288 compact v3 (verified 267/267 numpy): lean op set, no validity in masks.

bottom row = bottommost nonzero (full-width structure) -> derive from g>0 alone.
"""
...
# bottomr = gpos & ~up(gpos)
up_gpos=shift("gpos",-1,0); add("Not",[up_gpos],["nug"]); add("And",["gpos","nug"],["bottomr"])
# apex = gpos & up(bottomr)
brup=shift("bottomr",-1,0); add("And",["gpos",brup],["apex"])
# corners
...
# ray = rayb & v & ~gpos
add("Not",["gpos"],["gbg"])
add("And",["rayb","v"],["r2"]); add("And",["r2","gbg"],["ray"])
# C
