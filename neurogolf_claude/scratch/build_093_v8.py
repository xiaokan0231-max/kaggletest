...
# Only 2 grid products needed; complementary side counts via per-line totals minus near side.
nodes.append(helper.make_node("Mul", ["mf", "above_row"], ["mA"]))   # grid
nodes.append(helper.make_node("Mul", ["mf", "left_col"], ["mL"]))    # grid
