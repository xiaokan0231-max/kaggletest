"""task036 v7: single-plane 8-neighbor discriminator + dynamic Slice/Pad crop,
with simplified contiguous-bbox extraction (ArgMax for min, ReduceSum for size).
Fewer nodes -> smaller file (memory scored by file size for the dynamic crop).
"""
import numpy as np
import onnx
