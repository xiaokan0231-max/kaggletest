"""task354 v4 (Route C): Conv full->f32 30x30, Slice f32 to 10x10, Cast uint8."""
import numpy as np
import onnx
...
nodes.append(h.make_node("Slice", ["g_full", "cs", "ce", "ca"], ["g_f32"]))
...
onnx.save(model, "/tmp/b12_task354c.onnx")
