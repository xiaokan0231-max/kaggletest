export const meta = {
  name: 'neurogolf-deepgolf-b12-local',
...
3. Else BUILD using the technique above. Save /tmp/b12_${t.task}.onnx. Crop to the common grid size if all examples share one (check first) to shrink tensors.
4. Verify: cd ${REPO} && python neurogolf_claude/tools/verify_local.py ${t.task} /tmp/b12_${t.task}.onnx -> "=== ${t.task}: READY=<bool> points=<float> ===".
