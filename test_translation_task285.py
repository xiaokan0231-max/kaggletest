                ...
                for ac in adj_colors:
                    ...
                    if len(r_ac) == 1:
                        ...
                        if best_k != -1:
                            ...
                            dir_r = r_ac[0] - closest_r
                            dir_c = c_ac[0] - closest_c
                            
                            # where is the pixel in the transformed crop?
                            # wait, what is the exact coordinate mapping?
                            print(f"Base {c}->{ac}: dir=({dir_r}, {dir_c}), out_shift=({best_dr}, {best_dc})")
