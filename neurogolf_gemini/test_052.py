...
def test_052():
    task_json_path = "/Users/kanxiao/IdeaProjects/kaggletest/neurogolf/data/raw/task052.json"
    ...
    print("Verifying task052...")
    
    examples = load_examples(52)
    model = onnx.load(onnx_path)
    
    try:
        verify_network(model, 52, examples)
