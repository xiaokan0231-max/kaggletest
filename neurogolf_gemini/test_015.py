...
def test_015():
    task_json_path = "/Users/kanxiao/IdeaProjects/kaggletest/neurogolf/data/raw/task015.json"
    ...
    print("Verifying task015...")
    
    examples = load_examples(15)
    model = onnx.load(onnx_path)
    
    try:
        verify_network(model, 15, examples)
