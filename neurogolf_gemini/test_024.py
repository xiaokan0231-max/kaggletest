...
def test_024():
    task_json_path = "/Users/kanxiao/IdeaProjects/kaggletest/neurogolf/data/raw/task024.json"
    ...
    print("Verifying task024...")
    
    examples = load_examples(24)
    model = onnx.load(onnx_path)
    
    try:
        verify_network(model, 24, examples)
