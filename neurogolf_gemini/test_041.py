...
def test_041():
    task_json_path = "/Users/kanxiao/IdeaProjects/kaggletest/neurogolf/data/raw/task041.json"
    ...
    print("Verifying task041...")
    
    examples = load_examples(41)
    model = onnx.load(onnx_path)
    
    try:
        verify_network(model, 41, examples)
